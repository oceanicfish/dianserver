 ...
 */
var app = angular.module('seatChartApp_D1', ['ngCookies']);

app.controller('seatChartController_D1', ['$http', '$scope', '$cookies','$cookieStore', function($http, $scope,$cookies, $cookieStore){

    $scope.selectedSeats = (!$cookies.getObject('selectedSeats')) ? [] : $cookies.getObject('selectedSeats');
    $scope.errorMessage = '';

    $scope.singlePrice = 50;
    ...
    $scope.occupiedSeats = ['D1', 'D10', 'D41'];
