 ...
 */
var app = angular.module('seatChartApp_C', ['ngCookies']);

app.controller('seatChartController_C', ['$http', '$scope', '$cookies','$cookieStore', function($http, $scope,$cookies, $cookieStore){

    $scope.selectedSeats = (!$cookies.getObject('selectedSeats')) ? [] : $cookies.getObject('selectedSeats');
    $scope.errorMessage = '';

    $scope.singlePrice = 100;
    ...
    $scope.occupiedSeats = ['C5', 'C19', 'C41'];
